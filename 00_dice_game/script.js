...
let player1Text = document.querySelector('#name--0');
let player2Text = document.querySelector('#name--1');

let listen = document.querySelectorAll('.form-control-file');

listen.forEach(element => {
    element.addEventListener('change', function(){
        if(player1Name.value){
            player1Text.textContent = player1Name.value;
        }else{
            player1Text.textContent = "PLAYER 1"
        }
        if(player2Name.value){
            player2Text.textContent = player2Name.value;
        }else{
